...
$(document).ready(function () {
	...
	var dataUnpack = function dataUnpack(message) {
	...
	var decorateWithFullVolume = function decorateWithFullVolume(message) {
	...
	var displayData = function displayData(messageToDisplay, from, tsym, fsym) {
